...
const flagComponents: Record<string, React.FC<{ style?: React.CSSProperties }>> = {
  ...
  EE, LV, LT, SK, SI, HR, BG, RS, BA, MK, AL, ME, MD, BY, AM, AZ, GE, KZ, UZ,
  KG, TJ, TM, MN, NP, LK, MM, KH, LA, BN, BT, MV, AF, IR, IQ, SY, JO, LB, KW,
  BH, QA, OM, YE, LY, TN, DZ, MA, SD, ET, KE, TZ, UG, RW, BI, SO, DJ, ER, GH,
  CI, SN, ML, BF, NE, TD, CM, CF, GQ, GA, CG, CD, AO, ZM, ZW, BW, NA, MZ, MG,
  MU, SC, KM, CV, ST, GN, GW, SL, LR, TG, BJ, GM, PR, CU, DO, HT, JM, TT, BB,
  BS, BZ, GT, HN, SV, NI, CR, PA, GY, SR, GF, FK, IM, JE, GG, MC, LI, AD, SM,
  VA, MT, CY, LU, IS, FO, GL, SJ, GI, BM, KY, VG, AI, MS, TC, AW, CW, SX, BQ,
  NC, PF, WF, NF, CX, CC, PN, NU, CK, TK, TV, NR, PW, FM, MH, KI, WS, AS, TO,
  VU, SB, PG, TL,
}
...
const countryMap: Record<string, string> = {
  ...
  'canada': 'CA', 'australia': 'AU', 'estonia': 'EE',
  ...
  'falkland islands': 'FK', 'isle of man': 'IM', 'jersey': 'JE', 'guernsey': 'GG',
  'monaco': 'MC', 'liechtenstein': 'LI', 'andorra': 'AD', 'san marino': 'SM',
  'vatican city': 'VA', 'malta': 'MT', 'cyprus': 'CY', 'luxembourg': 'LU',
  'iceland': 'IS', 'faroe islands': 'FO', 'greenland': 'GL',
  'svalbard and jan mayen': 'SJ', 'gibraltar': 'GI', 'bermuda': 'BM',
  'cayman islands': 'KY', 'british virgin islands': 'VG', 'anguilla': 'AI',
  'montserrat': 'MS', 'turks and caicos islands': 'TC', 'aruba': 'AW',
  'curaçao': 'CW', 'sint maarten': 'SX', 'bonaire': 'BQ', 'saba': 'BQ',
  'sint eustatius': 'BQ', 'new caledonia': 'NC', 'french polynesia': 'PF',
...
export const CountryFlag: React.FC<CountryFlagProps> = ({ 
  ...
  if (!code) return (
    <span className={className} style={{ display: 'inline-flex', lineHeight: 0 }}>
      <Globe size={size} style={{ opacity: 0.5 }} />
    </span>
  )
